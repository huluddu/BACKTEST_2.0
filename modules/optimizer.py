    ...
    for i, seed in enumerate(seeds):
        ...
        for t in trials:
            ...
            all_rows.append({
                ...
                "매매횟수":            res.total_trades,
                # 탐색된 파라미터 (trial params에서)
                "ma_buy":              tp_.get("ma_buy",      q.ma_buy),
                "offset_cl_buy":       tp_.get("off_cl_buy",  q.offset_cl_buy),
                "offset_ma_buy":       tp_.get("off_ma_buy",  q.offset_ma_buy),
                "buy_operator":        tp_.get("buy_op",      q.buy_operator),
                "ma_sell":             tp_.get("ma_sell",     q.ma_sell),
                "offset_cl_sell":      tp_.get("off_cl_sell", q.offset_cl_sell),
                "offset_ma_sell":      tp_.get("off_ma_sell", q.offset_ma_sell),
                "sell_operator":       tp_.get("sell_op",     q.sell_operator),
                "stop_loss_pct":       tp_.get("sl",          q.stop_loss_pct),
                "take_profit_pct":     tp_.get("tp",          q.take_profit_pct),
                # 고정 파라미터 (q 객체에서 - 원래 전략값)
                "use_trend_buy":       q.use_trend_buy,
                "use_trend_sell":      q.use_trend_sell,
                "ma_trend_short":      tp_.get("ma_ts",  q.ma_trend_short),
                "ma_trend_long":       tp_.get("ma_tl",  q.ma_trend_long),
                "offset_trend_short":  tp_.get("off_ts", q.offset_trend_short),
                "offset_trend_long":   tp_.get("off_tl", q.offset_trend_long),
                "use_atr_stop":        q.use_atr_stop,
                "atr_multiplier":      q.atr_multiplier,
                "use_rsi_filter":      q.use_rsi_filter,
                "rsi_period":          q.rsi_period,
                "rsi_min":             q.rsi_min,
                "rsi_max":             q.rsi_max,
                "use_macd":            q.use_macd,
                "macd_fast":           q.macd_fast,
                "macd_slow":           q.macd_slow,
                "macd_signal":         q.macd_signal_period,
                "macd_mode":           q.macd_mode,
                "use_market_filter":   q.use_market_filter,
                "market_ma_period":    q.market_ma_period,
            })
